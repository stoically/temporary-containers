...
<template>
  <div v-show="loaded" class="ui tab segment" data-tab="export_import">
    <div class="ui form">
      <div class="field">
        <button id="exportPreferences" v-on:click="exportPreferencesButton" class="ui button primary">Export Preferences</button>
      </div>
      <div class="field">
        <label>Import Preferences</label>
        <input id="importPreferences" v-on:change="importPreferencesButton" type="file" name="Import Preferences">
      </div>
    </div>
  </div>
</template>